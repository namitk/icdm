...
\begin{itemize}
\item \textbf{Results} : Able to match within 0.5\% of the estimates of methods based on full scan, while sampling (and labeling) just 2.5k instances from indexed unlabeled data
\end{itemize}
\begin{figure}
\begin{center}
